          ...
          {token && (
            <div className="hidden sm:flex items-center gap-x-3">
              ...
              <button
                ...
                className="flex items-center gap-x-2 px-3 py-2 rounded-lg bg-red-600 hover:bg-red-700 text-white text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-gray-900"
                aria-label="Logout"
              >
                <LogOut size={16} />
                <span>Logout</span>
      ...
      {isMenuOpen && (
        <div className="sm:hidden bg-gray-700 dark:bg-gray-800 border-t border-gray-600 dark:border-gray-700" id="mobile-nav">
          <div className="flex flex-col gap-y-2 px-4 py-3">
            ...
            {/* Logout — mobile, only if logged in */}
            {token && (
              <button
                onClick={handleLogout}
                className="flex items-center gap-x-2 py-2 px-3 rounded-md font-medium text-sm text-red-400 hover:bg-gray-600 dark:hover:bg-gray-700 transition-colors duration-200 text-left"
              >
                <LogOut size={16} />
                <span>Logout</span>
              </button>
